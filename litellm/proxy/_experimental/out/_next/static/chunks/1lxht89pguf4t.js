(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,176919,e=>{"use strict";var t=e.i(464012);let r=t.forwardRef(function(e,r){return t.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:2,stroke:"currentColor","aria-hidden":"true",ref:r},e),t.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"}))});e.s(["ExternalLinkIcon",0,r],176919)},764538,e=>{"use strict";let t=(0,e.i(585103).default)("external-link",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);e.s(["default",0,t])},556718,e=>{"use strict";var t=e.i(764538);e.s(["ExternalLink",()=>t.default])},707310,e=>{"use strict";let t=(0,e.i(585103).default)("link-2",[["path",{d:"M9 17H7A5 5 0 0 1 7 7h2",key:"8i5ue5"}],["path",{d:"M15 7h2a5 5 0 1 1 0 10h-2",key:"1b9ql8"}],["line",{x1:"8",x2:"16",y1:"12",y2:"12",key:"1jonct"}]]);e.s(["Link2",0,t],707310)},311192,e=>{"use strict";var t=e.i(855506);e.s(["LoaderCircle",()=>t.default])},848317,e=>{"use strict";var t=e.i(464012),r=(e,t,r,a,i,s,n,o)=>{let l=document.documentElement,p=["light","dark"];function d(t){var r;(Array.isArray(e)?e:[e]).forEach(e=>{let r="class"===e,a=r&&s?i.map(e=>s[e]||e):i;r?(l.classList.remove(...a),l.classList.add(s&&s[t]?s[t]:t)):l.setAttribute(e,t)}),r=t,o&&p.includes(r)&&(l.style.colorScheme=r)}if(a)d(a);else try{let e=localStorage.getItem(t)||r,a=n&&"system"===e?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e;d(a)}catch(e){}},a=t.createContext(void 0),i={setTheme:e=>{},themes:[]};t.memo(({forcedTheme:e,storageKey:a,attribute:i,enableSystem:s,enableColorScheme:n,defaultTheme:o,value:l,themes:p,nonce:d,scriptProps:m})=>{let u=JSON.stringify([i,a,o,e,p,l,s,n]).slice(1,-1);return t.createElement("script",{...m,suppressHydrationWarning:!0,nonce:"u"<typeof window?d:"",dangerouslySetInnerHTML:{__html:`(${r.toString()})(${u})`}})}),e.s(["useTheme",0,()=>{var e;return null!=(e=t.useContext(a))?e:i}])},198458,e=>{"use strict";var t=e.i(331166),r=e.i(423971),a=e.i(464012),i=e.i(741466);e.s(["useResourceList",0,function(e){let{queryKey:s,fetchPage:n,serializeFilters:o,defaultSorting:l,defaultPageSize:p,enabled:d}=e,[m,u]=(0,a.useState)(l),[c,g]=(0,a.useState)({pageIndex:0,pageSize:p}),[f,h]=(0,a.useState)([]),[x,_]=(0,a.useState)(""),[b]=(0,t.useDebouncedValue)(x,{wait:i.DEBOUNCE_WAIT_MS}),y=(0,a.useMemo)(()=>{let e=m.map(e=>e.desc?`-${e.id}`:e.id).join(","),t=b.trim();return{page:c.pageIndex+1,page_size:c.pageSize,...""===e?{}:{sort:e},...""===t?{}:{q:t},...o(f)}},[m,c.pageIndex,c.pageSize,b,f,o]),j={queryKey:[...s,y],queryFn:({signal:e})=>n(y,e),enabled:d,placeholderData:e=>e},{data:w,isLoading:v,isPlaceholderData:k,isFetching:N,error:$,refetch:C}=(0,r.useQuery)(j),S=(0,a.useCallback)(()=>g(e=>({...e,pageIndex:0})),[]),I=(0,a.useCallback)(e=>{u(e),S()},[S]),E=(0,a.useCallback)(e=>{h(e),S()},[S]),L=(0,a.useCallback)(e=>{_(e),S()},[S]),T=(0,a.useCallback)(()=>{C()},[C]);return{rows:(0,a.useMemo)(()=>w?.data??[],[w]),rowCount:w?.meta.total_count??0,isLoading:v||k,isFetching:N,error:$,refetch:T,sorting:m,onSortingChange:I,pagination:c,onPaginationChange:g,columnFilters:f,onColumnFiltersChange:E,searchValue:x,onSearchChange:L}}])},592392,e=>{"use strict";var t=e.i(62478),r=e.i(423971);let a=(0,e.i(243652).createQueryKeys)("proxySettings"),i={PROXY_BASE_URL:"",PROXY_LOGOUT_URL:"",LITELLM_UI_API_DOC_BASE_URL:null};e.s(["default",0,function(e){let{data:s}=(0,r.useQuery)({queryKey:[...a.all,e],queryFn:()=>(0,t.fetchProxySettings)(e),enabled:!!e});return s??i}])},945572,e=>{"use strict";var t=e.i(913924),r=e.i(519455),a=e.i(337822),i=e.i(419159),s=e.i(868068);let n=(0,e.i(585103).default)("languages",[["path",{d:"m5 8 6 6",key:"1wu5hv"}],["path",{d:"m4 14 6-6 2-3",key:"1k1g8d"}],["path",{d:"M2 5h12",key:"or177f"}],["path",{d:"M7 2h1",key:"1t2jsx"}],["path",{d:"m22 22-5-10-5 10",key:"don7ne"}],["path",{d:"M14 18h6",key:"1m8k6r"}]]);e.s(["default",0,()=>{let{language:e,setLanguage:o}=(0,i.useDashboardLanguage)(),l=s.resources[e].common.language,p="ru"===e?l.russian:l.english;return(0,t.jsxs)(a.Popover,{children:[(0,t.jsxs)(a.PopoverTrigger,{className:"inline-flex h-8 items-center gap-1.5 rounded-md px-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground","aria-label":`${l.selectorLabel}: ${p}`,title:l.selectorTitle,children:[(0,t.jsx)(n,{className:"size-4"}),(0,t.jsx)("span",{children:e.toUpperCase()})]}),(0,t.jsxs)(a.PopoverContent,{align:"end",className:"w-36 gap-1 p-1.5",children:[(0,t.jsx)(r.Button,{variant:"ghost",size:"sm",className:"w-full justify-start","aria-pressed":"en"===e,onClick:()=>void o("en"),children:l.english}),(0,t.jsx)(r.Button,{variant:"ghost",size:"sm",className:"w-full justify-start","aria-pressed":"ru"===e,onClick:()=>void o("ru"),children:l.russian})]})]})}],945572)},909947,e=>{"use strict";var t=e.i(865361);e.s(["generateCodeSnippet",0,e=>{let r,{apiKeySource:a,accessToken:i,apiKey:s,inputMessage:n,chatHistory:o,selectedTags:l,selectedVectorStores:p,selectedGuardrails:d,selectedPolicies:m,selectedVoice:u,endpointType:c,selectedModel:g,selectedSdk:f,proxySettings:h,customHeaders:x}=e,_="session"===a?i:s,b=window.location.origin,y=h?.LITELLM_UI_API_DOC_BASE_URL;y&&y.trim()?b=y:h?.PROXY_BASE_URL&&(b=h.PROXY_BASE_URL);let j=n||"Your prompt here",w=j.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n"),v=o.filter(e=>!e.isImage).map(({role:e,content:t})=>({role:e,content:t})),k={};l.length>0&&(k.tags=l),p.length>0&&(k.vector_stores=p),d.length>0&&(k.guardrails=d),m.length>0&&(k.policies=m);let N=g||"your-model-name",$=x&&Object.keys(x).length>0?`,
...
client = openai.OpenAI(
    ...
    extra_body=${e}`}let a=v.length>0?v:[{role:"user",content:j}];r=`
import base64
