...
async def get_image(theme: Literal["light", "dark"] | None = None):
    ...
    # Keep the downstream Nexoplane identity for both dashboard themes while
    # retaining upstream's theme-aware custom-logo fallback behaviour.
    bundled_light_logo: Final = os.path.join(current_dir, "nexoplane.jpg")
    bundled_dark_logo: Final = os.path.join(current_dir, "nexoplane.jpg")
