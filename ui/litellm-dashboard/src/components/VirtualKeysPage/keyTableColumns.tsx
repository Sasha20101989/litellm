...
export const getKeyTableColumns = ({
  ...
  return [
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("virtualKeys.columns.key")} variant="header-cycle" />,
    size: 260,
    enableSorting: true,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableSortHeader column={column} title={t("virtualKeys.columns.keyId")} variant="header-cycle" />,
    size: 120,
    enableSorting: true,
