...
async function testFallbackModelResponse(selectedModel: string, accessToken: string, t: TFunction<"settings">) {
  ...
  try {
    NotificationsManager.info(t("router.fallbacks.testing"));
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "user",
          content: t("router.fallbacks.testMessage"),
        },
      ],
      // @ts-ignore
    ...
    NotificationsManager.success(
      <span>
        {t("router.fallbacks.testSuccess", { requested: selectedModel, received: response.model })}{" "}
        <a
          href="#"
    ...
    <>
      ...
      {!hasFallbacks ? (
        ...
        <Table>
          <TableHead>
            <TableRow>
              <TableHeaderCell>{t("router.fallbacks.modelName")}</TableHeaderCell>
              <TableHeaderCell>{t("router.fallbacks.fallbacks")}</TableHeaderCell>
              <TableHeaderCell>{t("router.fallbacks.actions")}</TableHeaderCell>
            </TableRow>
          </TableHead>
              ...
              Object.entries(item).map(([key, value]) => (
                <TableRow key={index.toString() + key}>
                  ...
                  <TableCell className="align-top">
                    {canModify && (
                      <>
                        <Tooltip title={t("router.fallbacks.test")}>
                          <Icon
                            icon={PlayIcon}
                            size="sm"
                        ...
                        <Tooltip title={t("router.fallbacks.edit")}>
                          <span
                        ...
                        <Tooltip title={t("router.fallbacks.delete")}>
                          <span
      ...
      <DeleteResourceModal
        ...
        title={t("router.fallbacks.deleteTitle")}
        message={t("router.fallbacks.deleteMessage")}
        resourceInformationTitle={t("router.fallbacks.information")}
        resourceInformation={[
          {
            label: t("router.fallbacks.modelName"),
