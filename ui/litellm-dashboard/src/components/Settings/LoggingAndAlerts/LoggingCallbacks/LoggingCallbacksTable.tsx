...
export const LoggingCallbacksTable: React.FC<LoggingCallbacksProps> = ({
  ...
  return (
    <div className="mt-4 flex w-full flex-col gap-4">
      <h3 className="text-lg font-semibold tracking-tight text-foreground">{t("logging.callbacks.active")}</h3>
      <div>
        <Button onClick={onAdd}>
          <Plus />
          {t("logging.callbacks.add")}
        </Button>
      </div>
      <DataTable
        ...
        isLoading={isLoading}
        loadingMessage={t("logging.callbacks.loading")}
