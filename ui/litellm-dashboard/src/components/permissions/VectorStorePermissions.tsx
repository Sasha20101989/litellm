  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm font-semibold text-foreground">{t("virtualKeys.sharedDetails.vectorStores")}</p>
      ...
      {vectorStores.length > 0 ? (
        ...
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-muted border border-border">
          ...
          <p className="text-muted-foreground text-sm">{t("virtualKeys.sharedDetails.noVectorStores")}</p>
        </div>
      )}
    </div>
  );
