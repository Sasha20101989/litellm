...
const ROLE_HINT = "Nexoplane will mark all messages of this role as cacheable";
const INDEX_HINT = "(Optional) If set, Nexoplane will mark the message at this index as cacheable";
