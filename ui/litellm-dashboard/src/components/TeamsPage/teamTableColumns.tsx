  ...
  return [
    {
      ...
      header: ({ column }) => <DataTableSortHeader column={column} title={t("teams.table.team")} variant="header-cycle" />,
      size: 260,
      enableSorting: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => <DataTableSortHeader column={column} title={t("teams.table.created")} variant="header-cycle" />,
      size: 130,
      enableSorting: true,
