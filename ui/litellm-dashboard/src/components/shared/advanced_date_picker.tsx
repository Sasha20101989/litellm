...
const relativeTimeOptions = (t: (key: string) => string): RelativeTimeOption[] => [
  {
    label: t("virtualKeys.savings.today"),
    shortLabel: "today",
    getValue: () => ({
  ...
  {
    label: t("virtualKeys.savings.last7Days"),
    shortLabel: "7d",
    getValue: () => ({
  ...
  {
    label: t("virtualKeys.savings.last30Days"),
    shortLabel: "30d",
    getValue: () => ({
  ...
  {
    label: t("virtualKeys.savings.monthToDate"),
    shortLabel: "MTD",
    getValue: () => ({
  ...
  {
    label: t("virtualKeys.savings.yearToDate"),
    shortLabel: "YTD",
    getValue: () => ({
...
const AdvancedDatePicker: React.FC<AdvancedDatePickerProps> = ({
  ...
  const validateDateRange = useCallback(() => {
    ...
    if (!start.isValid() || !end.isValid()) {
      return { isValid: false, error: t("virtualKeys.savings.invalidDate") };
    }

    if (end.isBefore(start)) {
      return { isValid: false, error: t("virtualKeys.savings.invalidDateRange") };
    }
            ...
            <div className="flex">
              ...
              <div className="w-1/2 border-r border-border">
                <div className="p-3 border-b border-border">
                  <span className="text-sm font-semibold text-foreground">{t("virtualKeys.savings.relativeTime")}</span>
                </div>
              ...
              <div className="w-1/2 relative">
                <div className="p-3.5 border-b border-border">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-foreground">
                      {t("virtualKeys.savings.startEndDates")}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-6 pb-20">
                  {/* Start date */}
                  <div>
                    <label className="text-sm text-foreground mb-1 block">{t("virtualKeys.savings.startDate")}</label>
                    <input
                      type="date"
                      value={startDate}
                  ...
                  {/* End date */}
                  <div>
                    <label className="text-sm text-foreground mb-1 block">{t("virtualKeys.savings.endDate")}</label>
                    <input
                      type="date"
                      value={endDate}
