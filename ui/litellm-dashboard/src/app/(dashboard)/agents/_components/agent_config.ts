  ...
  basic: {
    ...
    fields: [
      ...
      },
      {
        ...
        defaultValue: "1.0",
        tooltip:
          "The A2A protocol version Nexoplane serves to clients for this agent. Nexoplane converts the upstream agent's responses to this version, so clients always see the version you pick here regardless of the original agent's version.",
        helpText:
          "Nexoplane serves this version to clients and converts the upstream agent's responses to match it, regardless of the original agent's version.",
      },
    ],
  },
  skills: {
