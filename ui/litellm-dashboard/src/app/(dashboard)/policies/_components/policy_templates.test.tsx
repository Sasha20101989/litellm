...
describe("PolicyTemplates", () => {
  ...
  it("renders template controls in Russian", async () => {
    ...
    expect(screen.getByRole("button", { name: "Использовать шаблон" })).toBeInTheDocument();
    expect(screen.getByText("Наследует:")).toBeInTheDocument();
  });
