      ...
      <Card>
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{t("vectorStores.test.selectDescription")}</p>
          </div>
          ...
          >
            <ComboboxInput className="w-full" placeholder={t("vectorStores.test.selectPlaceholder")} />
            <ComboboxContent>
              <ComboboxEmpty>{t("vectorStores.test.noMatches")}</ComboboxEmpty>
              <ComboboxList>
                {(store: VectorStore) => (
