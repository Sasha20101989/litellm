  ...
  if (!project) {
    return (
      ...
      >
        ...
        <Empty description={t("projects.notFound")} />
      </Content>
    );
  }
  ...
  return (
    <Content style={{ padding: token.paddingLG, paddingInline: token.paddingLG * 2 }}>
          ...
          <div>
            <Flex align="center" gap={8}>
              ...
              <Tag color={project.blocked ? "red" : "green"}>
                {project.blocked ? t("projects.blocked") : t("projects.active")}
              </Tag>
            </Flex>
            <Text type="secondary">
      ...
      <Row style={{ marginBottom: 24 }}>
        <Card>
          <Descriptions title={t("projects.details")} column={1}>
            <Descriptions.Item label={t("projects.description")}>{project.description || "\u2014"}</Descriptions.Item>
            <Descriptions.Item label={t("projects.created")}>
              {new Date(project.created_at).toLocaleString(i18n.resolvedLanguage === "ru" ? "ru-RU" : "en-US")}
              {project.created_by && (
                <Text>
                  &nbsp;{t("projects.by")}&nbsp;
            ...
            <Descriptions.Item label={t("projects.updated")}>
              {new Date(project.updated_at).toLocaleString(i18n.resolvedLanguage === "ru" ? "ru-RU" : "en-US")}
              {project.updated_by && (
                <Text>
                  &nbsp;{t("projects.by")}&nbsp;
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
          ...
          >
            <Flex vertical gap={16}>
              <div>
                ...
                <br />
                <Text type="secondary">
                  {hasLimit ? t("projects.budgetOf", { budget: maxBudget.toFixed(2) }) : t("projects.noBudget")}
                </Text>
              </div>
              {hasLimit && (
                <div>
                  ...
                  <Text type="secondary" style={{ fontSize: 12 }}>
                    {t("projects.utilized", { percent: (Math.round(spendPercent * 10) / 10).toFixed(1) })}
                  </Text>
                </div>
              )}
            </Flex>
        ...
        <Col xs={24} lg={16}>
          <Card title={t("projects.spendByModel")} style={{ height: "100%" }}>
            {modelSpendData.length > 0 ? (
              ...
              <Empty description={t("projects.noModelSpend")} image={Empty.PRESENTED_IMAGE_SIMPLE} />
            )}
          </Card>
        </Col>
      </Row>
        ...
        <Col xs={24} lg={12}>
          ...
          >
            {teamInfo ? (
                  ...
                  <Flex vertical gap={12}>
                    ...
                    <div>
                      ...
                      {(teamInfo.models?.length ?? 0) > 0 ? (
                        ...
                        <Text type="secondary">{t("projects.allModels")}</Text>
                      )}
                    </div>
              ...
              <Empty description={t("projects.noTeam")} image={Empty.PRESENTED_IMAGE_SIMPLE} />
            )}
          </Card>
        </Col>
      </Row>
