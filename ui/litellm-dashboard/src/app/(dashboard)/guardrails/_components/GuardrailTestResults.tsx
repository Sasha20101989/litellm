...
export function GuardrailTestResults({ results, errors }: GuardrailTestResultsProps) {
  ...
  return (
    <div className="space-y-3 border-t border-border pt-4">
      <h3 className="text-sm font-semibold">{t("guardrailsPage.playground.results.title")}</h3>
                    ...
                    {!isCollapsed && (
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          if (success) {
                            toast.success(t("guardrailsPage.playground.results.copied"));
                          } else {
                            toast.fromError(t("guardrailsPage.playground.results.copyFailed"));
                          }
                        }}
                      >
                        <Copy />
