    ...
    <div className="pii-configuration">
      <div className="flex justify-between items-center mb-5">
        <div className="flex items-center">
          <h4 className="m-0 text-lg font-semibold text-foreground">{t("guardrailsPage.pii.configure")}</h4>
        </div>
        <span className="text-muted-foreground">{t("guardrailsPage.pii.selected", { count: selectedEntities.length })}</span>
      </div>
