  ...
  return (
    <div className="p-2">
      ...
      <p className="text-sm text-muted-foreground">
        See how Nexoplane transforms your request for the specified provider.
      </p>
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>The request you would send to the Nexoplane /chat/completions endpoint.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>How Nexoplane transforms your request for the specified provider.</CardDescription>
